    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <h3>Hi, Khaira! Kamu mau baca buku apa hari ini?</h3>
            </div>
                ...
                <div class="item active">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b003.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Api Tauhid</h5>
                                            <h5 class="book-genre">Habiburrahman El Shirazy</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b004.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Pulang</h5>
                                            <h5 class="genre">Tere Liye</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b005.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Jembatan Horor</h5>
                                            <h5 class="genre">Nikmatus S</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b006.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Ayah</h5>
                                            <h5 class="genre">Andrea Hirata</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b002.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>The Magic Library</h5>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b008.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Daun yang Jatuh Tak Pernah Membenci Angin</h5>
                                            <h5 class="genre">Romance</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b001.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Hujan</h5>
                                            <h5 class="genre">Sci-Fi</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                       ...
                       <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="slider-item">
                                <div class="slider-image">
                                    <img src="img/books/b007.jpg" class="img-responsive w-75" alt="a" />
                                </div>
                                <div class="slider-main-detail">
                                    <div class="slider-detail">
                                        <div class="book-detail">
                                            <h5>Laskar Pelangi</h5>
                                            <h5 class="genre">Adventure</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
